...
/**
 * <p>
 * Title: convert copybook to different types
 * </p>
 *
 * <p>
 * Description: cloned from JCopybook2TableDlg
 * </p>
 *
 * <p>
...
public class JCopybookViewer extends JDialog {
...
//     System.out.println("field name=="+cp.FIELD_NAME+" gr eln="+cp.FIELD_GROUP_LEN);
	...
	public static void main(String[] args) {
		...
		// v.addElement("test2");
		// v.addElement("test3");
		// JCopybookViewer(JTextField textField,Container c,Vector listData, String
		// creator, JTable table, int row, int column) {
...
// using jtext
			...
			public void windowClosing(WindowEvent e) {
				...
				if (lastOpenDir.length > 0) {
					try {
						...
						output.close();
						System.out.println("saving " + lastOpenDir + " to " + lastOpenFile.getAbsoluteFile());
		...
		f.getContentPane().add(jPanel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		JLabel jLabel = new JLabel(
				"Copy (ctrl-c) copybook from col 1 (NOT from col 8 where the record level 01 is) and paste (ctrl-v) it in the text area above");
		// jLabel1.setText("Copyright 2004-2005 JKJE Pty Ltd. All Rights Reserved");
		f.getContentPane().add(jLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		...
		f.getContentPane().add(jLabel2, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		jPanel.add(okBtn, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 0, 0, 0), 0, 0));

		jPanel.add(clearBtn, new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		jPanel.add(importBtn, new GridBagConstraints(2, 0, 1, 1, 0, 0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		jPanel.add(exitBtn, new GridBagConstraints(3, 0, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 0, 0, 0), 0, 0));
			...
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				if (lastOpenDir.length > 0 && lastOpenDir[0] != "" || lastOpenDir[0] != null) {
					try {
						...
						output.write(lastOpenDir[0]);
						output.close();
						System.out.println("saving " + lastOpenDir[0] + " to " + lastOpenFile.getAbsoluteFile());
					} catch (IOException e2) {
					}
	...
	private void jbInit() throws Exception {
		...
		/*
		 * jButton1.setBackground(new Color(0, 105, 255)); jButton1.setFont(new
		 * java.awt.Font("Arial", Font.BOLD, 11)); jButton1.setForeground(Color.white);
		 * jButton1.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new
		 * Color(0, 214, 255), new Color(0, 150, 255), new Color(0, 51, 124), new
		 * Color(0, 73, 178))); //jButton1.setMaximumSize(new Dimension(71, 21));
		 * //jButton1.setMinimumSize(new Dimension(71, 21));
		 * //jButton1.setPreferredSize(new Dimension(71, 21));
		 * jButton1.setToolTipText(""); jButton1.setText("Cancel");
		 * jButton1.addActionListener(new JCopybookViewer_jButton1_actionAdapter(this));
		 */

		border6 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(178, 178, 178)),
				"Please Check the Required Fields");

		jButton5.setBackground(new Color(0, 105, 255));
		jButton5.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
		jButton5.setForeground(Color.white);
		jButton5.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		jButton6.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		jButton7.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		jButton8.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		jButton9.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		jButton10.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		jButton11.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		this.getContentPane().add(jPanel2, new GridBagConstraints(0, 1, 1, 1, 0.1, 0.1, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		jScrollPane2.setViewportView(jTable1);
		jPanel1.add(jScrollPane2, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		// easy(w)
		jPanel2.add(jButton5, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		// easy(f)
		jPanel2.add(jButton6, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		// sas
		jPanel2.add(jButton7, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

		// java
		jPanel2.add(jButton10, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		// sql
		jPanel2.add(jButton11, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		// display
		jPanel2.add(jButton8, new GridBagConstraints(5, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

		// export
		jPanel2.add(jButton9, new GridBagConstraints(6, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

		GridBagConstraints gbc_btnTalendXml = new GridBagConstraints();
		gbc_btnTalendXml.fill = GridBagConstraints.BOTH;
		gbc_btnTalendXml.insets = new Insets(0, 0, 0, 5);
...
//                               <schema>
					...
					if (i == 0) {
						jt.setText("<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "\n");
						jt.setText("<schema>" + "\n");
					}
					...
					if (ft.equals("COMP-3") || idec > 0 || ft.equals("NUMERIC")) {
						ifl = iIntegral + idec;
						String sfl = new Integer(ifl).toString();
						txt = txt + "  <column type=\"\" talendType=\"id_BigDecimal\" precision=\"" + decimal
								+ "\" pattern=\"\" originalLength=\"" + sfl + "\" originalDbColumnName=\"" + fn
								+ "\" nullable=\"true\"" + "\n";
						txt = txt + "   length=\"" + sfl + "\" label=\"" + fn
								+ "\" key=\"false\" default=\"\" comment=\"\"/>" + "\n";

					} else if (ft.equals("COMP-1")) {
						txt = txt
								+ "  <column type=\"\" talendType=\"id_Float\" precision=\"-1\" pattern=\"\" originalLength=\""
								+ fl + "\" originalDbColumnName=\"" + fn + "\" nullable=\"true\"" + "\n";
						txt = txt + "   length=\"" + fl + "\" label=\"" + fn
								+ "\" key=\"false\" default=\"\" comment=\"\"/>" + "\n";
					} else if (ft.equals("COMP-2")) {
						txt = txt + "  <column type=\"\" talendType=\"id_Double\" precision=\"" + decimal
								+ "\" pattern=\"\" originalLength=\"" + fl + "\" originalDbColumnName=\"" + fn
								+ "\" nullable=\"true\"" + "\n";
						txt = txt + "   length=\"" + fl + "\" label=\"" + fn
								+ "\" key=\"false\" default=\"\" comment=\"\"/>" + "\n";
					} else if (ft.equals("COMP")) {
						if (ifl > 4) {
							// txt=txt+comma+fn+" Integer\n";
							txt = txt
									+ "  <column type=\"\" talendType=\"id_Integer\" precision=\"-1\" pattern=\"\" originalLength=\""
									+ fl + "\" originalDbColumnName=\"" + fn + "\" nullable=\"true\"" + "\n";
							txt = txt + "   length=\"" + fl + "\" label=\"" + fn
									+ "\" key=\"false\" default=\"\" comment=\"\"/>" + "\n";

						} else {
							// txt=txt+comma+fn+" smallint\n";
							txt = txt
									+ "  <column type=\"\" talendType=\"id_Integer\" precision=\"-1\" pattern=\"\" originalLength=\""
									+ fl + "\" originalDbColumnName=\"" + fn + "\" nullable=\"true\"" + "\n";
							txt = txt + "   length=\"" + fl + "\" label=\"" + fn
					...
					// else if (ft.equals("NUMERIC")&&idec>0) {
					// ifl=iIntegral+idec;
					// String sfl=new Integer(ifl).toString();
					// txt=txt+" <column type=\"\" talendType=\"id_BigDecimal\"
					// precision=\""+decimal+"\" pattern=\"\" originalLength=\""+sfl+"\"
					// originalDbColumnName=\""+fn+"\" nullable=\"true\""+"\n";
					// txt=txt+" length=\""+sfl+"\" label=\""+fn+"\" key=\"false\" default=\"\"
					// comment=\"\"/>"+"\n";
					// }
					else {
//<column type="" talendType="id_String" precision="-1" pattern="" originalLength="3" originalDbColumnName="ProductType" nullable="true" 
//length="3" label="ProductType" key="false" default="" comment=""/>
						txt = txt
								+ "  <column type=\"\" talendType=\"id_String\" precision=\"-1\" pattern=\"\" originalLength=\""
								+ fl + "\" originalDbColumnName=\"" + fn + "\" nullable=\"true\"" + "\n";
						txt = txt + "   length=\"" + fl + "\" label=\"" + fn
								+ "\" key=\"false\" default=\"\" comment=\"\"/>";
					}
		...
		btnTalendXml.setText("Talend XML");
		btnTalendXml.setForeground(Color.WHITE);
		btnTalendXml.setFont(new Font("Arial", Font.BOLD, 11));
		btnTalendXml.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED,

				new Color(0, 214, 255), new Color(0, 150, 255), new Color(0, 51, 124),

				new Color(0, 73, 178)));
		btnTalendXml.setBackground(new Color(0, 105, 255));
		jPanel2.add(btnTalendXml, gbc_btnTalendXml);
		jButton2.setBackground(new Color(0, 105, 255));
		jButton2.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
		jButton2.setForeground(Color.white);
		jButton2.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		jButton4.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		jButton3.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(0, 214, 255),
				new Color(0, 150, 255), new Color(0, 51, 124), new Color(0, 73, 178)));
		...
		// new Insets(0, 0, 0, 0), 0, 0));
		// selectall
		jPanel2.add(jButton3, new GridBagConstraints(4, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
		// unselectall
		jPanel2.add(jButton4, new GridBagConstraints(5, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));

		// ok
		jPanel2.add(jButton2, new GridBagConstraints(6, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		jPanel3.add(jPanel4, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.2, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		jPanel4.add(displayCurr, new GridBagConstraints(0, 0, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		jPanel4.add(displayAll, new GridBagConstraints(0, 1, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		jPanel4.add(displayRange, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		jPanel4.add(jTextField, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		jPanel4.add(jLabel, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		jPanel4.add(jTextField2, new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		jPanel3.add(jPanel5, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.2, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		this.getContentPane().add(jPanel1, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.SOUTH,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		jPanel5.add(displayVert, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		jPanel5.add(displayHorizontal, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
	...
	Border border1 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
// Border border2 = new TitledBorder(border1, "Select Tables for FROM clause");
	...
	Border border3 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	Border border4 = new TitledBorder(border3, "Select A Table");
	Border border5 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	Border border6 = new TitledBorder(border5, "Check Columns");
	Border border7 = BorderFactory.createEtchedBorder(Color.white, new Color(178, 178, 178));
...
//     s=s.trim();
	...
	public void jButton5_actionPerformed(ActionEvent e) {
		...
		for (int i = 0; i < data.length; i++) {
			...
			if (lvl == 1 && s2.length() > 0) {
				...
				if (s2.length() > 0) {
					if (s2.equals("GROUP"))
						...
						fn01 = (String) data[i][1];
				} else
					fn01 = "W";
			}

			/*
			 * if (lvl>prevlvl){ prevlvl = lvl; fn01=""; }
			 */
			if (!selected)
				continue;
			...
			if (fn.length() < 25 && fn2.length() < 25 && offset.length() < 8 && fl.length() < 8) {
				str[i] = fn + whiteSpaces(25 - fn.length()) + fn2 + whiteSpaces(25 - fn2.length()) + offset
						+ whiteSpaces(8 - offset.length()) + fl + whiteSpaces(8 - fl.length()) + ft + " " + dec + "\n";
			} else {
				str[i] = fn + "  " + fn2 + " " + offset + "   " + fl + " " + ft + " " + dec + "\n";
			}
			if (isWrite)
	...
	public void jButton6_actionPerformed(ActionEvent e) {
		...
		for (int i = 0; i < data.length; i++) {
			...
			if (fn.length() < 30 && fl.length() < 8 && offset1.length() < 8) {
				str[i] = fn + whiteSpaces(30 - fn.length()) + offset1 + whiteSpaces(8 - offset1.length()) + fl
						+ whiteSpaces(8 - fl.length()) + ft + " " + dec + "\n";
			} else {
				str[i] = fn + " " + offset1 + "   " + fl + " " + ft + " " + dec + "\n";
			}
			if (isWrite)
				jt.setText(jt.getText() + str[i]);
	...
	public void jButton7_actionPerformed(ActionEvent e) {
		...
		for (int i = 0; i < data.length; i++) {
			...
			fn = fn.replace('-', '_');
			if (fn.length() < 30 && fl.length() < 8 && offset1.length() < 8) {
				str[i] = "@" + offset1 + whiteSpaces(8 - offset1.length()) + fn + whiteSpaces(30 - fn.length()) + ft
						+ fl + "." + dec + "\n";
			} else {
				str[i] = "@" + offset1 + "  " + fn + "   " + ft + fl + "." + dec + "\n";
			}
			if (isWrite)
				jt.setText(jt.getText() + str[i]);
	...
	public void jButton8_actionPerformed(ActionEvent e) {
		...
		if (rowSelected == -1)
			rowSelected = 0;
		jkje.utils.HTMLDisplay dis = new HTMLDisplay("Copybook Table Layout", dir, "print01.html", "copybook", jTable1,
				rowSelected);
...
// SQL Create
		...
		for (int i = 0; i < data.length; i++) {
			...
			if (ft.equals("COMP-3")) {
				...
				if (ifl > 4)
					...
					txt = txt + comma + fn + " int\n";
				// } else if (ft.equals("NUMERIC")&&(idec>0)) {
			} else if (ft.equals("NUMERIC")) {
				txt = txt + comma + fn + " Decimal(" + fl + "," + decimal + ")\n";
			} else if (ifl < 3) {
				txt = txt + comma + fn + " Char(" + fl + ")\n";
			} else {
	...
	/*
	 * public void jList_valueChanged(ListSelectionEvent e) { int rowSelected=0;
	 * String tableSelected=""; String tableId=""; JList src=(JList)e.getSource();
	 * 
	 * if (e.getValueIsAdjusting()==false) { int[]
	 * selectedIndices=src.getSelectedIndices(); //
	 * System.out.println("selected indices are: "); for (int
	 * i=0;i<selectedIndices.length;i++) {
	 * //System.out.println(selectedIndices[i]+" "); } Object[]
	 * selectedValues=src.getSelectedValues(); //
	 * System.out.println("selected values are: "); for (int
	 * i=0;i<selectedValues.length;i++) { //
	 * System.out.println(selectedValues[i]+" ");
	 * tableSelected=(String)selectedValues[i]; } StringTokenizer st = new
	 * StringTokenizer(tableSelected," "); if (st.hasMoreTokens()) {
	 * tableSelected=st.nextToken(); } if (st.hasMoreTokens()) {
	 ...
	 * JDBCTableAdapter jt=new JDBCTableAdapter(); int j=tableSelected.indexOf(".");
	 * if (j>0) { tableSelected=tableSelected.substring(j+1,tableSelected.length());
	 * } String sql="Select NAME from sysibm.syscolumns where tbname = '"+
	 * tableSelected.toUpperCase()+"' AND TBCREATOR = '"+creator.toUpperCase()
	 * +"' order by colno"; String s3=""; try { s3 =
	 * jkje.tools.Tools.getSql(jkje.app.Registry.getDbms(),"draw",sysSqlFileName); }
	 * catch (Exception ee){}
	 * 
	 * if (s3.length()>0){ s3=s3.replaceAll("#tblName",tableSelected);
	 * s3=s3.replaceAll("#tblCreator",creator); sql=s3.trim(); }
	 * 
	 * // System.out.println("sql="+sql); Vector v=jt.getRows(sql); Enumeration
	 * en=v.elements(); int i=-1; while (en.hasMoreElements()) { i=i+1; String
	 * s2=en.nextElement().toString(); String s1=s2.substring(1,s2.length()-1); if
	 * (tableId.length()>0) data[i][0]=tableId+"."+s1; else data[i][0]=s1;
	 * data[i][1]=new Boolean(false); } model.fireTableDataChanged();
	 * 
	 * }
	 */
	...
	String[] columnNames = { "Filed Name", "Redefine/Group", "Field Type", "Start", "End", "Field Length", "Integral",
			"Decimal Places", "Signed?", "PIC Pattern", "Check to Select" };
// String[] columnNames2={"Filed Name", "Redefine/Group","Field Type", "Start" ,"End", "Field Length", "Decimal Places", "PIC Pattern"};
	...
	Border border9 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	...
	Border border12 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	Border border13 = new TitledBorder(border12, "Print options");
	Border border14 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	Border border15 = new TitledBorder(border14, "Display/Print options");
	Border border16 = BorderFactory.createEtchedBorder(Color.white, new Color(178, 178, 178));
	Border border17 = new TitledBorder(border16, "Check the required columns to display");
	Border border18 = BorderFactory.createEtchedBorder(Color.white, new Color(178, 178, 178));
	Border border19 = new TitledBorder(border18, "Check the required columns");
	Border border20 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	Border border21 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));

	JTextField jTextField = new JTextField();
	JTextField jTextField2 = new JTextField();
	JLabel jLabel = new JLabel(" to ");
	Border border22 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	Border border23 = new TitledBorder(border22, "Ra");
	Border border24 = BorderFactory.createEtchedBorder(Color.white, new Color(178, 178, 178));
	Border border25 = new TitledBorder(border24, "View");
	Border border26 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	Border border27 = new TitledBorder(border26, "View");
	Border border28 = BorderFactory.createEtchedBorder(Color.white, new Color(178, 178, 178));
	Border border29 = new TitledBorder(border28, "Range");
	Border border30 = BorderFactory.createEtchedBorder(Color.white, new Color(178, 178, 178));
	Border border31 = new TitledBorder(border30, "Range option");
	Border border32 = BorderFactory.createEtchedBorder(EtchedBorder.RAISED, Color.white, new Color(178, 178, 178));
	Border border33 = new TitledBorder(border32, "View option");
	private final JButton btnTalendXml = new JButton();
...
class JCopybookViewer_jButton1_actionAdapter implements ActionListener {
...
class JCopybookViewer_jButton2_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton3_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton4_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton5_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton6_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton7_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton8_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton9_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton10_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
...
class JCopybookViewer_jButton11_actionAdapter implements ActionListener {
	private JCopybookViewer adaptee;
